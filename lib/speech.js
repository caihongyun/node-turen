...
function TurenSpeech(connectorFn, options) {
  ...
  this.connectorFn = connectorFn || defaultConnectorFn;
  this.speakId = -1;
  this.response = {};
  this.config = null;
 ...
 * @method initRpc
 */
TurenSpeech.prototype.initRpc = function() {
  if (this.rpcClient) {
    this.rpcClient.disconnect();
    this.rpcClient = null;
  }
  this.rpcClient = new TurenRpc(this.connectorFn, { autoConnects: true });
 ...
 * @method initEvent
 */
TurenSpeech.prototype.initEvent = function() {
  this.eventHandler = new TurenEvent(this.connectorFn);
